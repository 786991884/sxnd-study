				...
				function() {
					...
					if (flag == 'add') {
						...
						$('#tree_org').treegrid(
								'append',
								{
									...
									data : [ {
										...
										principal : $('#myform').find(
												'input[name=principal]').val(),
										description : $('#myform').find(
						...
						$.ajax({
							...
							data : {
								parentId : node.id,
								name : $('#myform').find('input[name=name]')
										.val(),
								count : $('#myform').find('input[name=count]')
										.val(),
								principal : $('#myform').find(
										'input[name=principal]').val(),
								description : $('#myform').find(
...
<body>
	...
	<div id="div1" title="组合机构" class="easyui-dialog" style="width: 400px;"
