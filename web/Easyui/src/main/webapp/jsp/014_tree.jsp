...
<script type="text/javascript">
	...
	function remove() {
		...
		//后台删除
		$.post('ResourceServlet?method=delete', {
			id : node.id
		}, function(reuslt) {
			//给出提示信息 
			$.messager.show({
...
<body>
	<ul id="t1"></ul>
	<div id="mydiv" title="设置权限" class="easyui-dialog"
		style="width: 300px;" closed=true>
		<form id="myform" method="post">
			...
			<table>
				...
				<tr align="center">
					<td colspan="2"><a id="savebtn" class="easyui-linkbutton">确定</a>
						<a id="cancelbtn" class="easyui-linkbutton">取消</a></td>
				</tr>
			</table>
		</form>
	</div>
