		...
		<table cellpadding="10">
			<c:forEach items="${bookpage.list }" var="book">
				<tr>
					...
					<td>${book.price }</td>
					<td><a
						href="bookServlet?method=addToCart&pageNo=${bookpage.pageNo }&id=${book.id}&title=${book.title}">加入购物车</a>
					</td>
				</tr>
			</c:forEach>
		</table>
		<br> <br> 共${bookpage.totalPageNumber }页 &nbsp;&nbsp;
		当前页${bookpage.pageNo}页&nbsp;&nbsp;
