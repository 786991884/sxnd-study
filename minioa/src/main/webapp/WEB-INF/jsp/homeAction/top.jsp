...
<body CLASS=PageBody leftmargin=0 topmargin=0 marginwidth=0 marginheight=0>
	...
	<div id="Head1">
		...
		<div id="Head1Right_SystemButton">
			<a href="${pageContext.request.contextPath}/userAction_logout.action" target="_parent"> <img width="78" height="20" alt="退出系统" src="${pageContext.request.contextPath}/style/blue/images/top/logout.gif" />
			</a>
		</div>
	...
	<div id="Head2">
		<div id="Head2_Awoke">
			<ul id="AwokeNum">
				...
				<!-- 是否有待审批文档的提示1 -->
				<li><a href="${pageContext.request.contextPath}/formFlowAction_myTaskList.action" target="right"> <img border="0" width="12" height="14" src="${pageContext.request.contextPath}/style/images/top/wait.gif" /> 待办事项（<span id="wait" class="taskListSize">0</span>）
				</a></li>
				<li class="Line"></li>
