	...
	<div id="box" align="center" style="width: 1200">
		...
		<div id="main">
			...
			<div id="banner">
				...
				<div id="banner2">
					<img src="images/1117.gif" width="265" height="78" /> <img
						src="images/1118.gif" width="265" height="78" />
				</div>
			</div>
			<div id="line"></div>
			<div id="left">
			...
			<div id="right">
				...
				<div id="sale_title">特价商品</div>
				<%
					if (prodList != null) {
						for (int i = 0; i < prodList.size(); i++) {
							Product product = (Product) prodList.get(i);
							String isspecial = product.getIsspecial();
							if (isspecial.equals("y")) {
								String id = product.getProdid();
								String prodName = product.getProdname();
								String prodPrice = String.valueOf(product
										.getProdprice());
								String prodImg = product.getProdimg();
				%>
				<div id="new2">
				...
				<div id="top_bg">
					<%
						if (prodList != null) {
							for (int i = 0; i < prodList.size(); i++) {
								Product product = (Product) prodList.get(i);
								String isfashion = product.getIsfashion();
								if (isfashion.equals("y")) {
									String id = product.getProdid();
									String prodName = product.getProdname();
									String prodPrice = String.valueOf(product
											.getProdprice());
									...
									if (prodType.equals("cosmetics")) {
										prodType = "化妆品";
									} else if (prodType.equals("bag")) {
										prodType = "手袋&包包";
									} else if (prodType.equals("watch")) {
										prodType = "手表&手饰";
									} else {
										prodType = "时尚";
									}
					...
					<div id="top1">
						<div id="top1_pic">
							|
							<%=prodType%>
							<br /> <a href="details.jsp?id=<%=id%>"><img
								src="<%=prodImg%>" width="145" height="108" /></a>
						</div>
						<div id="top1_list">
							<span class="font01"><%=prodName%></span> <br />
							<%=prodPrice%>
						</div>
					</div>
					<%
