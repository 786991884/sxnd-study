 ...
 * 5.3.1 前置通知: @Before("execution(public int ArithmeticCalculator.*(int, int))")
 *
...
public class LoggingAspect {
    ...
    @Before("execution(public int com.xubh.spring.aop.ArithmeticCalculator.*(int, int))")
    ...
    @After("execution(* com.xubh.spring.aop.*.*(..))")
